...
(function($) {
    ...
    * ------------------------------------------------------ */
    var clMenuOnScrolldown = function() {
        ...
        var menuTrigger = $('.header-menu-toggle'),
            soundSwitch = $('.header-sound-switch');

        $WIN.on('scroll', function() {

            if ($WIN.scrollTop() > 150) {
                menuTrigger.addClass('opaque');
                soundSwitch.addClass('opacity');
            }
            else {
                menuTrigger.removeClass('opaque');
                soundSwitch.removeClass('opacity');
            }
    ...
    * ------------------------------------------------------ */
    ...
    /* Sound Switch
    * ----------------------------------------------------- */
    var clSoundSwitch = function() {
        var video = $('.shadow-video'),
            switchButton = $('.header-sound-switch');
        
        video.prop('muted', true);

        switchButton.click('click', function(){
            if (video.prop('muted')) {
